...
namespace flychams::control
{
	...
	public: // Constructor/Destructor
		DroneControl(const core::ID& agent_id, core::NodePtr node, core::SettingsTools::SharedPtr config_tools, core::TopicTools::SharedPtr topic_tools, core::TransformTools::SharedPtr transform_tools, core::CallbackGroupPtr module_cb_group)
