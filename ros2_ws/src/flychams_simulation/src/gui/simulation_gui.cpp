...
namespace flychams::simulation
{
    ...
    void SimulationGui::onInit()
    {
        ...
        agent_.status_sub = topic_tools_->createAgentStatusSubscriber(agent_id_,
            std::bind(&SimulationGui::statusCallback, this, std::placeholders::_1), sub_options_with_module_cb_group_);
        agent_.gui_setpoints_sub = topic_tools_->createGuiSetpointsSubscriber(agent_id_,
            std::bind(&SimulationGui::setpointsCallback, this, std::placeholders::_1), sub_options_with_module_cb_group_);
    ...
    void SimulationGui::statusCallback(const AgentStatusMsg::SharedPtr msg)
    {
        // Update agent status
    ...
    void SimulationGui::setpointsCallback(const GuiSetpointsMsg::SharedPtr msg)
    {
    ...
    void SimulationGui::resetWindows(std::vector<WindowCmd>& window_cmds)
    {
    ...
    void SimulationGui::drawWindow(const DrawCmd& draw_cmd)
    {
