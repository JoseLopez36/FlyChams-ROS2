...
namespace flychams::simulation
{
    ...
    public: // Constructor/Destructor
        MetricsFactory(core::NodePtr node, core::ConfigTools::SharedPtr config_tools, core::TopicTools::SharedPtr topic_tools, core::TransformTools::SharedPtr transform_tools, core::CallbackGroupPtr module_cb_group)
    ...
    public: // Types
        ...
        struct Agent
        {
            ...
            Agent()
                ...
                optimization_duration_sub(), observation_setpoints_sub(), metrics_pub()
            {
            }
        };
        struct Target
    ...
    private: // Callbacks
        ...
        void agentObservationSetpointsCallback(const core::ID& agent_id, const core::AgentObservationSetpointsMsg::SharedPtr msg);
