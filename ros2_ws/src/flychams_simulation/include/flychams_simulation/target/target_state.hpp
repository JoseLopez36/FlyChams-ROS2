...
namespace flychams::simulation
{
    ...
    public: // Constructor/Destructor
        TargetState(const core::ID& target_id, core::NodePtr node, core::ConfigTools::SharedPtr config_tools, core::TopicTools::SharedPtr topic_tools, core::TransformTools::SharedPtr transform_tools, core::CallbackGroupPtr module_cb_group)
