...
namespace flychams::common
{
    ...
    public: // Types
        ...
        struct Ellipsoid
        {
            common::Vector3r a0;     // Initial ellipsoid center
            common::Matrix3Xr A0;    // Initial ellipsoid matrix
        };
        struct Data
        {
            // Cost function data
    ...
    public: // Public methods
        void init(const Parameters& params, const CostFunctions::CostParameters& cost_params)
        {
            ...
            ellipsoid_.A0 = common::Matrix3r::Zero();
    ...
    private: // Optimization methods
        float optimize(common::Vector3r& x_opt, bool convex_relaxation)
        {
            ...
            common::Vector3r a = ellipsoid_.a0;
            common::Matrix3Xr A = ellipsoid_.A0;
      ...
      // Define the constraint values
           ...
           // Find the first constraint that is violated (g[i] > 0)
            ...
            common::Vector3r best_a = a;  // Best solution found
        ...
        void ellipsoidal_covering(common::Vector3r& a, const common::Vector3r& v, float d, common::Matrix3Xr& A)
        {
