...
namespace flychams::agent
{
    ...
    private: // Tracking methods
        ...
        std::tuple<float, float, common::Crop, float, float> updateWindow(const common::Vector3r& P, const float& r, const common::Matrix4r& T, const float& f, common::ObservationSolver::SharedPtr solver);
