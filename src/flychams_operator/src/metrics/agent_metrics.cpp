...
{
    agent_.upsilons_norm.assign(msg->upsilons_norm.begin(), msg->upsilons_norm.end());
...
void AgentMetrics::update()
{
    ...
    msg.upsilons_norm = agent_.has_observation_setpoints ? agent_.upsilons_norm : std::vector<float>{};
